...
dependencies {
	...
	modImplementation("com.teamresourceful.resourcefulconfig:resourcefulconfig-fabric-${if (resConfigMcVersion == "") minecraftVersion else resConfigMcVersion}:$resConfigVersion")
