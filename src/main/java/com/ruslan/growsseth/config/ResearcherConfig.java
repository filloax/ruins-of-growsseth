...
public final class ResearcherConfig {
    ...
    @Comment(
            value = "The researcher teleports back to his original position after five minutes away from it, and avoids interacting with nether portals to prevent cheese.",
