...
class SimplePools(private val context: BootstapContext<StructureTemplatePool>) {
    ...
    companion object {
        fun bootstrap(ctx: BootstapContext<StructureTemplatePool>) = SimplePools(ctx).bootstrap()
    }
