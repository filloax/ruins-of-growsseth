...
class OptionalLootItemTags {
    ...
    fun optionalModLootTableItem(key: ResourceKey<Item>): TagKey<Item> {
        val tag = tagFromKey(key.identifier())
    ...
    fun optionalModLootTableItem(id: Identifier): TagKey<Item> {
    ...
    private fun tagFromKey(id: Identifier) = TagKey.create(Registries.ITEM, id.withPrefix("mod_compat_loot_table_items/"))
}