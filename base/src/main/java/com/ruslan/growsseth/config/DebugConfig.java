...
public class DebugConfig {
    @ConfigEntry(id = "debugNpcDialogues", translation = T_PREF + "debugNpcDialogues.name")
    public static boolean debugNpcDialogues = false;

    @ConfigEntry(id = "structuresDebugMode", translation = T_PREF + "structuresDebugMode.name")
    ...
    @ConfigEntry(id = "researcherSpeedup", translation = T_PREF + "researcherSpeedup.name")
